...
function Card({ children }: { children: React.ReactNode }) {
  return <div className="rounded-3xl bg-neutral-100 p-6 shadow-sm">{children}</div>;
}

/* === Панели === */
function Delivery() {
  return (
    <section id="panel-delivery" role="tabpanel" className="space-y-6">
      <h2 className="text-4xl font-black uppercase tracking-tight" style={{ color: ACCENT }}>
        Доставка и оплата
      </h2>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <Card>
          ...
          <p className="mt-2">Если вещи не подошли — оплачивается только стоимость доставки.</p>
          <p className="mt-2">
        ...
        <Card>
          ...
          <p>
            Доставка по всей России (службы доставки, напр. СДЭК). Стоимость и сроки рассчитываются в
            корзине в зависимости от адреса и веса заказа.
          </p>
        ...
        <Card>
          ...
          <p className="mt-2">Ориентировочные сроки: 4–10 дней. Для стран СНГ — 3–10 дней.</p>
        </Card>
      </div>
    </section>
  );
...
function Returns() {
  return (
    <section id="panel-returns" role="tabpanel" className="space-y-6">
      <h2 className="text-4xl font-black uppercase tracking-tight" style={{ color: ACCENT }}>
        Возврат и обмен
      </h2>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <Card>
          ...
          <ul className="list-disc space-y-2 pl-5">
            <li>
              Срок возврата — <b>14 календарных дней</b> с момента получения.
            </li>
            <li>Товар должен быть без следов носки, с ярлыками.</li>
            <li>Возврат денег тем же способом, которым была оплата.</li>
          </ul>
        </Card>
        ...
        <Card>
          ...
          <p>
            Напишите на{" "}
            <a href="mailto:info@dh22.ru" className="underline" style={{ color: ACCENT }}>
              info@dh22.ru
            </a>{" "}
            или в{" "}
            <a
            ...
            : номер заказа, ФИО и причина возврата/обмена.
          </p>
        </Card>
        ...
        <Card>
          ...
          <p>
            Индивидуально изготовленные и явно использованные товары обмену и возврату не подлежат
            (следы носки/повреждения/нет ярлыков).
          </p>
        </Card>
      </div>
    </section>
...
function Contacts() {
  return (
    <section id="panel-contacts" role="tabpanel" className="space-y-6">
      <h2 className="text-4xl font-black uppercase tracking-tight" style={{ color: ACCENT }}>
        Контакты
      </h2>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <Card>
          ...
          <a href="mailto:info@dh22.ru" className="font-medium underline" style={{ color: ACCENT }}>
            info@dh22.ru
          </a>
        </Card>
